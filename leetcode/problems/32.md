...
最后，最长连续已配对标记的长度，就是最长有效括号的长度。做法同 [485. 最大连续 1 的个数](https://leetcode.cn/problems/max-consecutive-ones/)，[我的题解](https://leetcode.cn/problems/max-consecutive-ones/solutions/2993237/jian-dan-ti-jian-dan-zuo-pythonjavaccgoj-b8i9/)。
