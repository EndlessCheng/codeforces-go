...
由于 $(x,y)$ 在矩形中，所以有 $x_1\le x\le x_2$ 且 $y_1\le y\le y_2$。

根据勾股定理，$(x, y)$ 到圆心 $(x_\textit{center},y_\textit{center})$ 的距离的平方为
...
成立，那么 $(x,y)$ 在圆中，说明圆和矩形相交。否则，到圆最近的点都不在圆中，说明圆和矩形不相交。
