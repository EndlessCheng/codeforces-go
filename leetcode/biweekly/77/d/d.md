...
![LC2258-1-c.png](https://pic.leetcode.cn/1699328814-LLKNdF-LC2258-1-c.png)

如图，火可能要绕很多圈才能到达左上角，人可以在被火烧到的前一分钟出发。

所以粗略估计，就用 $mn$ 当作答案的上界。
...
二分结束后，如果发现等 $mn$ 分钟都可以到达安全屋，说明火被堵住了（或者压根就没有火），返回 $10^9$。
...
这就引出了最后的问题：人可以在初始位置停留 $t_2-t_1$ 分钟吗？

![LC2258-2-c.png](https://pic.leetcode.cn/1699329505-EOqVpw-LC2258-2-c.png)
