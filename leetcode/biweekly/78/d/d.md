...
设出现次数最多的字母为 $a$，出现次数最少的字母为 $b$。由于题目求的是这两个字母出现次数的差，我们可以把 $a$ 视作 $1$，$b$ 视作 $-1$，其余字母视作 $0$，于是问题转化成一个类似 [53. 最大子数组和](https://leetcode.cn/problems/maximum-subarray/) 的问题。

**请先学习 53 题的 DP 做法，再继续阅读。**

## 状态机 DP

本题的难点在于，$a$ 和 $b$ **必须都在子串中**。
