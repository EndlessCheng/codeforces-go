...
设答案为 $k$。由于 $k$ 越小，越能完成 $k$ 个任务，$k$ 越大，越无法完成 $k$ 个任务，可以二分答案。关于二分算法，请看 [二分查找 红蓝染色法【基础算法精讲 04】](https://www.bilibili.com/video/BV1AP41137w7/)。

现在问题变成：

- 给定 $k$，选择 $k$ 个任务，以及 $k$ 名工人。能否把工人与任务一一配对，使得每名工人都能完成相应的任务？
