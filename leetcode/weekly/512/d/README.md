...
[本题视频讲解](https://www.bilibili.com/video/BV1Ps3j6nE3D/?t=17m20s)，欢迎点赞关注~

## 答疑

**问**：为什么不能用 DP 做？能不能只考虑往右和往下两个方向？

**答**：假设 $\textit{penalty}$ 中只有 $0$ 和 $\infty$，那么 $\infty$ 的格子可以视作墙壁（障碍物）。在有障碍物的网格中移动，必须考虑四个方向，否则可能连终点都无法到达。具体的构造见视频讲解中的图。
