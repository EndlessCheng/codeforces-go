...
不妨从 $0$ 开始 DFS。（你想从其他节点开始 DFS 也可以。）
...
- 如果 $\textit{cnt}_2[0] > \textit{cnt}_2[1]$ ，那么第一棵树的节点 $i$ 应当连到集合 $B$ 中的任意节点，这样节点 $i$ 在第二棵树中的目标节点为 $\textit{cnt}_2[0]$
- 否则，第一棵树的节点 $i$ 应当连到集合 $A$ 中的任意节点，这样节点 $i$ 在第二棵树中的目标节点为 $\textit{cnt}_2[1]$。

所以节点 $i$ 在第二棵树中的目标节点，至多为
