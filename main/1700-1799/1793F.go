...
func (t seg93) update(o, i, v int) {
	if t[o].l == t[o].r {
		t[o].minDiff = min(t[o].minDiff, abs93(v-t[o].a[0]))
...
func (t seg93) query(o, l int) int {
	if l <= t[o].l {
		return t[o].minDiff
	}
	if (t[o].l+t[o].r)>>1 < l {
...
func cf1793F(_r io.Reader, _w io.Writer) {
	...
	ans := make([]int, q)
	t := make(seg93, 2<<bits.Len(uint(n-1)))
	t.build(a, 1, 1, n)
	for r, qi := 2, 0; r <= n; r++ {
		curMin = 2e9
...
//func main() { cf1793F(os.Stdin, os.Stdout) }
func abs93(x int) int { if x < 0 { return -x }; return x }
