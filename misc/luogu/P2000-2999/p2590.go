...
func (t seg590) mergeInfo(a, b data590) data590 {
	return data590{max(a.mx, b.mx), a.s + b.s}
}

func (t seg590) maintain(o int) {
	t[o].val = t.mergeInfo(t[o<<1].val, t[o<<1|1].val)
}

func (t seg590) build(a []int, o, l, r int) {
	t[o].l, t[o].r = l, r
	if l == r {
		t[o].val = data590{a[l], a[l]}
		return
	}
	m := (l + r) >> 1
	t.build(a, o<<1, l, m)
...
func (t seg590) update(o, i, v int) {
	if t[o].l == t[o].r {
		t[o].val = data590{v, v}
		return
	}
...
func (t seg590) query(o, l, r int) data590 {
	if l <= t[o].l && t[o].r <= r {
		return t[o].val
	}
	m := (t[o].l + t[o].r) >> 1
...
func p2590(in io.Reader, _w io.Writer) {
	...
	t := make(seg590, 2<<bits.Len(uint(n-1)))
	...
	queryPath := func(v, w int) (res data590) { res.mx = -1e18; doPath(v, w, func(l, r int) { res = t.mergeInfo(res, t.query(1, l, r)) }); return }
