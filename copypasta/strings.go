...
func _() {
	...
	// 时间复杂度：O(n)
	// 看代码，如果 s[i+k] < s[j+k]，那么我们排除
	//
	// 模板题 https://www.luogu.com.cn/problem/P13270 https://www.luogu.com.cn/problem/P1368 http://poj.org/problem?id=1509 https://codeforces.com/gym/103585/problem/K
