...
https://oeis.org/A236753 任意长度 Number of simple (non-intersecting) directed paths in (n X n)-grid graph
...
func backtracking() {
	...
	// https://codeforces.com/problemset/problem/534/F 2400 打印方案
